...
public class SDESEncoding {
	...
	public static void main(String[] args) {
		...
		System.out.println("===== SDES Message Encoding Program =====\n");

		String message = "CRYPTOGRAPHY";
		byte[] rawkey = new byte[] {0,1,1,1,0,0,1,1,0,1};
		
		System.out.println("Given message: " + message);
		System.out.println("Given rawkey : " + Arrays.toString(rawkey));
		
		// Start with encryption.
		System.out.println("\n---------- Encryption ----------");
		byte[] plaintext = CASCII.Convert(message);
		
		System.out.println("Message as bits: " + Arrays.toString(plaintext) + "\n");

		byte[] ciphertextRes = Encrypt(rawkey, plaintext);
		
		System.out.println("=============== Result ===============\n");
		
		System.out.println("Ciphertext as bits  : " + Arrays.toString(ciphertextRes));
		System.out.println("Ciphertext as String: " + CASCII.toString(ciphertextRes) + "\n");
		
		// Proceed to decryption.
		System.out.println("---------- Decryption ----------");
		
		byte[] plaintextRes = Decrypt(rawkey, ciphertextRes);
		
		System.out.println("Ciphertext being decrypted: " + CASCII.toString(ciphertextRes));
		System.out.println("With rawkey: " + Arrays.toString(rawkey) + "\n");
		
		System.out.println("=============== Result ===============\n");
		
		System.out.println("Original message as bits  : " + Arrays.toString(plaintextRes));
		System.out.println("Original message as string: " + CASCII.toString(plaintextRes));
